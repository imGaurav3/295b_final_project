...
def recommend_songs_for_user_preferences(model, df, scaler, user_mood, user_era, num_recommendations):
    # Assume df is your original dataset and it has been processed as per the model's requirements
    ...
    return filtered_songs[['Track_id', 'Name', 'Artist', 'Release_Year', 'Valence']]
...
with open('multi_target_rf_model.pkl', 'wb') as model_file:
    pickle.dump(multi_target_rf, model_file)
